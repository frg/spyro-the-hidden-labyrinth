...
@script RequireComponent(GoodCharacterControl)
...
//Character Control
private var c_characterControl : GoodCharacterControl;
...
public function Awake () : void {
	...
	target = transform;
	c_characterControl = GetComponent(GoodCharacterControl);
...
public function LateUpdate () : void {
	...
	if (AngleDistance (f_currentAngle, f_targetAngle) > 160 && c_characterControl.IsMovingBackwards ()) {
		f_targetAngle += 180;
	}
